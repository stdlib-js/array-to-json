...
```javascript
import typedarray2json from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-to-json@v0.1.0-deno/mod.js';
```
...
[@stdlib/array/reviver]: https://github.com/stdlib-js/array-reviver/tree/deno
